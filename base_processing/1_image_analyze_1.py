...
img = cv2.imread(get_base_file_path('images/track_edited.jpg'), cv2.IMREAD_GRAYSCALE)
...
# save the output_img
cv2.imwrite(get_base_file_path('images/output.jpg'), output_img)
import pickle as pkl
pkl.dump(top_contours, open(get_base_file_path('saves/track_contours.pkl'), 'wb'))
